...
//                                                if (dataSnapshot.exists()) {
                    ...
                    //this condition is just an example for  supplier authentification , you can uncomment the code of firebase to activate all our  suppliers authentification
                                                   if (userEmail.equals("anass@gmail.com") && userPass.equals("anas123")) {
                                                    progressBar.setVisibility(View.GONE);
                                                    Paper.book().write("active","admin");
                                                    Intent intent = new Intent(AdminLoginActivity.this, AdminHome.class);
                                                    Toast.makeText(AdminLoginActivity.this, "Welcom dear supplier", Toast.LENGTH_SHORT).show();
